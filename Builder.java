...
public class Builder implements ContextBuilder<Object>{
	...
	public Context build(Context<Object> context) { 
		//TODO: hay un warning sobre la necesidad de parametrizar el context
		...
		/** Valor minimo del indice de conectividad con base en el cual se generan las conexiones en la red social */
		double minConect = params.getDouble("minConect");
		/** Valor maximo del indice de conectividad con base en el cual se generan las conexiones en la red social */
		double maxConect = params.getDouble("maxConect");
